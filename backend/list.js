...
const sustainableIngredients = [
    ...
    new Ingredient("Titanium Dioxide", 4, "Commonly used mineral pigment, but concerns may arise from production processes."),
    new Ingredient("Manganese Violet", 5, "May contain synthetic colorants with potential environmental impacts."), new Ingredient("Iron Oxides (CI 77491, CI 77492)", 4, "Commonly used mineral pigments, but concerns may arise from production processes."),
    new Ingredient("Yellow 5 Lake (CI 19140)", 5, "Synthetic colorant with potential environmental concerns."),
    new Ingredient("Yellow 5 Lake", 5, "Synthetic colorant with potential environmental concerns."),
    new Ingredient("Dimethicone", 3, "A silicone-based ingredient with potential environmental impacts."),
    ...
    new Ingredient("Iron Oxides", 4, "Commonly used mineral pigments, but concerns may arise from production processes."),
    new Ingredient("Bismuth Oxychloride (CI 77163)", 5, "May contain synthetic colorants with potential environmental impacts."),
    new Ingredient("Bismuth Oxychloride", 5, "May contain synthetic colorants with potential environmental impacts."),
    new Ingredient("Talc", 3, "Commonly mined mineral with potential health and environmental concerns."),
    new Ingredient("Boron Nitride", 5, "Generally safe, but the environmental impact may arise from mining practices."),
    new Ingredient("Nylon-12", 4, "Synthetic polymer with potential environmental concerns."),
    new Ingredient("Silica", 3, "Generally safe, but the environmental impact may arise from mining practices."),
    ...
    new Ingredient("Sorbic Acid", 5, "Synthetic preservative with potential environmental concerns."),
    new Ingredient("Manganese Violet (CI 77742)", 5, "May contain synthetic colorants with potential environmental impacts."),
    new Ingredient("Manganese Violet", 5, "May contain synthetic colorants with potential environmental impacts."),
    new Ingredient("Iron Oxides (CI 77491, CI 77492, CI 77499)", 4, "Commonly used mineral pigments, but concerns may arise from production processes."),
    new Ingredient("Titanium Dioxide (CI 77891)", 4, "Commonly used mineral pigment, but concerns may arise from production processes."),
    new Ingredient("Carmine", 5, "Natural colorant with potential environmental concerns."),
    ...
    new Ingredient("Humectant Blend", 7, "Combination of glycerin and hyaluronic acid, commonly plant-derived. Hyaluronic acid may involve energy-intensive production."),
    new Ingredient("Rich Emollients", 8, "Includes squalane, vitamin E, safflower, and avocado oils. Generally plant-derived, but the score can vary based on sourcing practices."),
    new Ingredient("Persea Gratissima Oil", 8, "Avocado oil is plant-derived and nutrient-rich, but the score can vary based on sourcing practices."),
    new Ingredient("Carthamus Tinctorius Seed Oil", 8, "Safflower oil is plant-derived, and the score can vary based on sourcing practices."),
    new Ingredient("Glycine Soja Oil", 7, "Soybean oil is plant-derived, but concerns may arise from large-scale monoculture."),
    new Ingredient("Ferric Ferrocyanide", 5, "Colorant with potential environmental concerns, and the score may vary based on production methods."),
    new Ingredient("Caprylyl Methicone", 4, "Silicone-based ingredient with potential environmental impacts."),
    new Ingredient("Octyldodecanol", 6, "Fatty alcohol often derived from palm oil, associated with deforestation and environmental concerns."),
    new Ingredient("Isononyl Isononanoate", 4, "Synthetic ester with potential environmental impacts."),
    new Ingredient("Isopropyl Palmitate", 4, "Ester of isopropyl alcohol and palmitic acid, which may have environmental considerations."),
    new Ingredient("Aloe Barbadensis Leaf Juice", 9, "Aloe vera juice is typically sustainable and has soothing properties."),
    new Ingredient("Cannabis Sativa Seed Extract", 8, "Extracted from hemp seeds, which can be sustainably sourced."),
    new Ingredient("Agave Tequilana Leaf Extract", 8, "Derived from the leaves of the agave plant, commonly used in skincare products."),
    new Ingredient("Prunus Avium Flower Extract", 8, "Extract from cherry flowers, which can be sustainably sourced."),
    new Ingredient("Melia Azadirachta Leaf Extract", 8, "Neem leaf extract, known for its beneficial properties."),
    new Ingredient("Melia Azadirachta Flower Extract", 8, "Neem flower extract, known for its beneficial properties."),
    new Ingredient("Corallina Officinalis Extract", 7, "Red seaweed extract, commonly used in skincare products."),
    new Ingredient("Orchis Mascula Extract", 8, "Extract from the orchid flower, often used in skincare formulations."),
    new Ingredient("Coccinia Indica Fruit Extract", 8, "Extract from the fruit of the ivy gourd plant, commonly used in skincare."),
    new Ingredient("Solanum Melongena Fruit Extract", 8, "Extract from eggplant fruit, known for its skincare benefits."),
    new Ingredient("Opuntia Ficus-Indica Flower Extract", 8, "Extract from the flower of the prickly pear cactus."),
    new Ingredient("Ocimum Sanctum Leaf Extract", 8, "Extract from the leaves of holy basil, known for its soothing properties."),
    new Ingredient("Curcuma Longa Leaf Extract", 8, "Extract from the leaves of turmeric, known for its anti-inflammatory properties."),
    new Ingredient("Cannabis Sativa Seed Oil", 8, "Hemp seed oil, which can be sustainably sourced."),
    new Ingredient("Moringa Oleifera Seed Oil", 8, "Moringa seed oil, known for its antioxidant properties."),
    new Ingredient("Vegetable Amino Acids", 7, "Amino acids derived from vegetables, and the score may depend on the specific sourcing."),
    new Ingredient("Hydrogenated Olive Oil Unsaponifiables", 5, "May have environmental impacts depending on the olive oil sourcing and hydrogenation process."),
    new Ingredient("Maltose", 7, "Sugar derived from malt, and the score depends on the sourcing and processing methods."),
    new Ingredient("Sodium Phytate", 7, "Salt form of phytic acid, commonly used in skincare formulations."),
    new Ingredient("Erythritol", 7, "Sugar alcohol often used as a sweetener, and the score depends on sourcing and processing."),
    new Ingredient("Methyl Gluceth-10", 7, "Synthetic compound derived from glucose, and the score may vary based on production methods."),
    new Ingredient("Pentylene Glycol", 7, "Synthetic compound used as a solvent, and the score may vary based on production methods."),
    new Ingredient("PVP", 3, "Polyvinylpyrrolidone, a synthetic polymer with potential environmental concerns."),
    new Ingredient("Sorbitol", 7, "Sugar alcohol commonly used in skincare, and the score depends on sourcing and processing."),
    new Ingredient("Propylene Glycol", 4, "Synthetic compound with potential environmental impacts."),
    new Ingredient("Pentaerythrityl Tetra-Di-T-Butyl Hydroxyhydrocinnamate", 4, "Antioxidant with potential environmental impacts."),
    new Ingredient("Amber Powder", 5, "Powder derived from fossilized tree resin, and the score may depend on extraction methods."),
    new Ingredient("Homarine HCl", 3, "Synthetic compound with potential environmental concerns."),
    new Ingredient("Hydroxyacetophenone", 6, "Synthetic compound often used as a preservative, and the score may vary based on production methods."),
    new Ingredient("Sodium Acetate", 5, "Salt often used in skincare formulations, and the score may depend on sourcing and processing."),
    new Ingredient("Benzoic Acid", 6, "Synthetic compound used as a preservative, and the score may vary based on production methods."),
    new Ingredient("Dehydroacetic Acid", 6, "Synthetic compound used as a preservative, and the score may vary based on production methods."),
    new Ingredient("Blue 1", 3, "Synthetic colorant with potential environmental concerns."),
